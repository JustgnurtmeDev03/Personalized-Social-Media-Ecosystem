...
const Sidebar = ({ unreadCount, unreadMSCount }) => {
  ...
  return (
    <div className="main-sidebar">
      ...
      <div className="main-menu">
        ...
        <div className="mmn-messages mmn-item relative">
          <Link to="/messages">
            <svg
            ...
            {unreadMSCount > 0 && (
              <span className="absolute top-3 right-5 inline-flex items-center justify-center w-3 h-3 bg-red-500 rounded-full"></span>
            )}
          </Link>
        </div>
      ...
      <div className="more-menu">
        ...
        <div className="mn-more mn-item" onClick={handleMenuToggle}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
