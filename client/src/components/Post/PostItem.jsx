      ...
      <div className="posts-content max-w-l bg-white p-4 rounded-lg shadow-md mb-2">
            ...
            {post.images?.length > 0 && (
              <div className="post-image">
                {post.images.map((image, index) => (
                  ...
                  >
                    <div
                      className="relative flex-shrink-0 w-48 md:w-56 rounded-lg overflow-hidden bg-gray-100 cursor-pointer"
                      style={{
                        width: "auto",
                        height: "100%",
                        aspectRatio:
        ...
        <div className="flex items-center mt-4 text-gray-500">
          <button
            ...
            onClick={(e) => {
              e.preventDefault(); // Ngăn điều hướng khi click vào nút like
