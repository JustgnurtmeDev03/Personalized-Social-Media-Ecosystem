...
exports.getFollowing = exports.getFollowers = exports.removeFollower = exports.unfollowUser = exports.followUser = void 0;
...
exports.removeFollower = asyncHandler_1["default"](function (req, res, next) { return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                followeeId = req.user._id.toString();
                followerId = req.params._id;
                if (followeeId === followerId) {
                    throw new httpError_1.HttpError(httpStatus_1["default"].BAD_REQUEST, message_1.USERS_MESSAGES.CANNOT_REMOVE_YOURSELF);
                }
                return [4 /*yield*/, followService_1.FollowService.removeFollower(followeeId, followerId)];
            case 1:
                _b.sent();
                res
                    .status(httpStatus_1["default"].OK)
                    .json({ message: message_1.USERS_MESSAGES.REMOVE_FOLLOWER_SUCCESS });
                return [2 /*return*/];
        }
    });
}); });
