...
exports.createComment = asyncHandler_1["default"](function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, threadId, content, userId, result, error_2;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _a = req.body, threadId = _a.threadId, content = _a.content;
                userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
                if (!userId) {
                    throw new Error("User not authenticated");
                }
                logger_1["default"].info("Creating comment for post ID: " + threadId);
                return [4 /*yield*/, commentService_1.CommentService.createComment(threadId, userId, content)];
            case 1:
                result = _c.sent();
