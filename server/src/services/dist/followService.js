...
var FollowService = /** @class */ (function () {
    ...
    FollowService.removeFollower = function (followeeId, followerId) {
        return __awaiter(this, void 0, Promise, function () {
            var follow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        follow = _a.sent();
                        if (!follow) {
                            throw new AppError_1.AppError("User is not following you", httpStatus_1["default"].BAD_REQUEST);
                        }
                        return [4 /*yield*/, follow.deleteOne()];
                    case 2:
                        _a.sent();
                        logger_1["default"].info("User " + followeeId + " removed follower " + followerId);
                        return [2 /*return*/];
                }
            });
        });
